...
//		16) Print all the 3 models and their prices
		...
		Thread.sleep(2000);
//		WebElement cityN1 = ll2.get(0).findElement(By.xpath("//td[1]"));
//		cityName = cityN1.getText();
...
//			WebElement modelN = ll2.get(i).findElement(By.xpath("//td[1]"));
//			modelName = modelN.getText();
//			WebElement priceA = ll2.get(i).findElement(By.xpath("//td[2]"));	
...
//		}
		...
		WebElement cityN1 = ll2.get(0).findElement(By.xpath("//td[1]"));
		String cityName1 = cityN1.getText();
		WebElement modelN1 = ll2.get(0).findElement(By.xpath("//td[2]"));
		String modelName1 = modelN1.getText();
		WebElement priceA1 = ll2.get(0).findElement(By.xpath("//td[3]"));	
		String priceAmount1 = priceA1.getText();
		System.out.println(city+" - "+cityName1+" , "+model+" - "+modelName1+" , "+exShowroomPrice+ " - "+priceAmount1);
		
		
//		WebElement cityN2 = ll2.get(1).findElement(By.xpath("//td[1]"));
//		String cityName2 = cityN2.getText();
		WebElement modelN2 = ll2.get(1).findElement(By.xpath("//td[1]"));
		String modelName2 = modelN2.getText();
		WebElement priceA2 = ll2.get(1).findElement(By.xpath("//td[2]"));	
		String priceAmount2 = priceA2.getText();
		System.out.println(city+" - "+cityName1+" , "+model+" - "+modelName2+" , "+exShowroomPrice+ " - "+priceAmount2);
		
		
//		WebElement cityN3 = ll2.get(2).findElement(By.xpath("//td[1]"));
//		String cityName3 = cityN3.getText();
		WebElement modelN3 = ll2.get(2).findElement(By.xpath("//td[1]"));
		String modelName3 = modelN3.getText();
		WebElement priceA3 = ll2.get(2).findElement(By.xpath("//td[2]"));	
		String priceAmount3 = priceA3.getText();
		System.out.println(city+" - "+cityName1+" , "+model+" - "+modelName3+" , "+exShowroomPrice+ " - "+priceAmount3);
		
		
			
		
//		for (WebElement eachElement : ll2) {
//			cityName = eachElement.findElement(By.xpath("//td[1]")).getText();
//			modelName = eachElement.findElement(By.xpath("//td[2]")).getText();
//			priceAmount = eachElement.findElement(By.xpath("//td[3]")).getText();
//		}
